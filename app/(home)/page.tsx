...
const page = () => {
   return (
      <div className="mt-[120px] w-full py-10">
         <div className="container mx-auto flex flex-col items-center justify-start gap-5 py-10">
            ...
            <div className="h-fit w-full items-center justify-center lg:grid lg:grid-cols-2">
               <div className="flex h-full w-full flex-col items-center justify-center lg:justify-center lg:gap-5"></div>
            </div>
         </div>
         <div className="container mx-auto flex flex-col items-center justify-start gap-5 bg-slate-100 py-10">
            <div className="text-center">
               <h1 className="text-lg font-semibold text-teal-700 lg:text-2xl">
                  KẾT NỐI FUTA GROUP
               </h1>
            ...
            <div className="h-fit w-full items-center justify-center lg:grid lg:grid-cols-2"></div>
         </div>
         <div className="container mx-auto flex flex-col items-center justify-start gap-5 py-10">
            <div className="text-center">
               <h1 className="text-lg font-semibold text-teal-700 lg:text-2xl">
